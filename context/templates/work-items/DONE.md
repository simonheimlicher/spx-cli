...
| --------------------------------- | ------------------------------------------------- | ----- |
| [Requirement text from work item] | `test/unit/config/loader.test.ts::test_name`      | 1     |
| [Requirement text from work item] | `test/integration/hugo.integration.test.ts::name` | 2     |
| [Requirement text from work item] | `test/e2e/cli.e2e.test.ts::test_name`             | 3     |
...
| Generated test data  | Uses factories from `test/fixtures/factories.ts` |
...
$ npm test
 ...
 ✓ test/unit/config/loader.test.ts (5 tests)
 ✓ test/unit/runners/lhci.test.ts (3 tests)
 ✓ test/integration/hugo.integration.test.ts (2 tests)
 ✓ test/e2e/cli.e2e.test.ts (2 tests)
